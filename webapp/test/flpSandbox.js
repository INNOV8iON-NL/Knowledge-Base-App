		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Articles",
									"targetURL": "#articlesfreestyle-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"articlesfreestyle-display": {
								"semanticObject": "articlesfreestyle",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=articlesfreestyle",
									"url": sap.ui.require.toUrl("articlesfreestyle")
								}
							}
						}
					}
